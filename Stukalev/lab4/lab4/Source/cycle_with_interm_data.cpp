...
public:
    ...
    void cycle()
    {
        ...
        for (int ind_f = 0, ind_s = 0;;)
        {
            ...
            {
                std::cout << "Equel elements:    " << first_string[ind_f] << "[" << ind_f << "]" << "==" << second_string[ind_s] << "[" << ind_s << "]" << '\n';
                ind_f++;
                ind_s++;
            }
            ...
            {
                std::cout << "Nonequel elements: " << first_string[ind_f] << "[" << ind_f << "]" << "!=" << second_string[ind_s] << "[" << ind_s << "]" <<'\n';
                if(ind_s == 0)
                    ind_f++;
                else
